...
const Navbar = () => {
  ...
  return (
    <div className="w-full">
      <nav className="container relative flex flex-wrap items-center justify-between p-8 mx-auto lg:max-w-7xl lg:justify-between xl:px-0">
        {/* Logo  */}
        <Disclosure>
          {({ open }) => (
            <>
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                ...
                <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                  <>
                    ...
                    <Link
                      href="/"
                      className="w-full px-6 py-2 mt-3 text-center text-white bg-red-500 rounded-md lg:ml-5"
                    >
                      Get Started
                    </Link>
                  </>
        ...
        <div className="hidden mr-3 space-x-4 lg:flex nav__item">
          <Link
            href="/"
            className="px-6 py-2 text-white bg-red-500 rounded-md md:ml-5"
          >
            Get Started
          </Link>
